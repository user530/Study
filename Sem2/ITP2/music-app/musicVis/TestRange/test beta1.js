/* 
FIX LIST:
1) Use more than one song, to prevent loading wait times;
2) Maybe Combine Next + Prev Song functions into one(?);
3) When add/del song dont stop and not move select from current song;
