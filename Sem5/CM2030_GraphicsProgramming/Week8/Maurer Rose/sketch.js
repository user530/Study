...
function draw() {
  ...
  d = dSlider.value() + map(noise(frameCount / 40000), 0, 1, -100, 100);
  n = nSlider.value() + map(noise(frameCount / 40000), 0, 1, -100, 100);
...
function drawSliders() {
  ...
  text(
    "d = " + dSlider.value(),
    dSlider.x + dSlider.width + 10,
    dSlider.y + 17
  );
  nSlider.position(20, 30);
  text(
    "n = " + nSlider.value(),
    nSlider.x + nSlider.width + 10,
    nSlider.y + 17
  );
}
