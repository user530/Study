...
Officer: 2481930
CaseNum: 801-2-11865577-2481930
...
You’ll have to use a single for loop to pick them out and set recognised property of the seats to true.
...
function draw()
{
    ...
    for (let i = 0 ; i < seats.length ; i++)
        {
            seats[i][gangMembers[i]].recognised = true;
        }
