...
Officer: 2481930
CaseNum: 302-3-22422364-2481930
...
function draw()
{
    ...
    spotlight1.x += (spotlight1.endX-spotlight1.x)/50 * 
                        2 ^ (1/(spotlight1.endX-spotlight1.x));
    spotlight1.y += (spotlight1.endY-spotlight1.y)/50 * 
                        2 ^ (1/(spotlight1.endY-spotlight1.y));
    
    spotlight2.x += (spotlight2.endX-spotlight2.x)/50 * 
                        2 ^ (1/(spotlight2.endX-spotlight2.x));
    spotlight2.y += (spotlight2.endY-spotlight2.y)/50 * 
                        2 ^ (1/(spotlight2.endY-spotlight2.y));
    
    spotlight3.x += (spotlight3.endX-spotlight3.x)/50 * 
                        2 ^ (1/(spotlight3.endX-spotlight3.x));
    spotlight3.y += (spotlight3.endY-spotlight3.y)/50 * 
                        2 ^ (1/(spotlight3.endY-spotlight3.y));
