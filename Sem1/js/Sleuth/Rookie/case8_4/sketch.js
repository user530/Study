...
Officer: 2481930
CaseNum: 402-3-52040397-2481930
...
function draw()
{
    ...
    if (det.locationX >= 199 && det.locationY == 139)
	{
		det.speedX = 1;
		det.speedY = 0;
	}
    
    if (det.locationX == 705 && det.locationY < 141)
	{
		det.speedX = 0;
		det.speedY = 1;
	}
    
    if ((det.locationX > 254 && det.locationX < 706) && det.locationY == 270)
	{
		det.speedX = -1;
		det.speedY = 0;
	}
    
    if (det.locationX == 255 && (det.locationY >= 270 && det.locationY <= 450))
	{
		det.speedX = 0;
		det.speedY = 1;
	}
    
     if ((det.locationX >= 255 && det.locationX <= 830) && det.locationY == 450)
	{
		det.speedX = 1;
		det.speedY = 0;
	} 
    
     if (det.locationX == 830 && (det.locationY >= 450))
	{
		det.speedX = 0;
		det.speedY = 1;
	} 
    
      if (det.locationX >= 445 && (det.locationY == 570))
	{
		det.speedX = -1;
		det.speedY = 0;
	} 
    
      if (det.locationX == 445 && (det.locationY >500 && det.locationY <= 630))
	{
		det.speedX = 0;
		det.speedY = 1;
	} 
