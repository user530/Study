...
Officer: 2481930
CaseNum: 402-2-59084675-2481930
...
function draw()
{
    ...
    if (det.locationX == 700 && (det.locationY > 72 && det.locationY < 321))
	{
		det.speedX = 0;
		det.speedY = 1;
	}
    
    if ((det.locationX > 385 && det.locationX < 701) && (det.locationY == 320))
	{
		det.speedX = -1;
		det.speedY = 0;
	}
    
    if ((det.locationX == 385) && (det.locationY > 319 && det.locationY < 445))
	{
		det.speedX = 0;
		det.speedY = 1;
	}
    
    if ((det.locationX > 195 && det.locationX < 386) && (det.locationY == 445))
	{
		det.speedX = -1;
		det.speedY = 0;
	}
    
    if ((det.locationX == 195) && (det.locationY > 444 && det.locationY < 630))
	{
		det.speedX = 0;
		det.speedY = 1;
	}
    
    if ((det.locationX > 75 && det.locationX < 196) && (det.locationY == 630))
	{
		det.speedX = -1;
		det.speedY = 0;
	}
