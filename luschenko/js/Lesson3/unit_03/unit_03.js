...
function f1() {
  const i1 = +document.querySelector("input.i-1").value;
  document.querySelector(".out-1").innerHTML = i1 == 4;
}
...
function f3() {
  let i31 = +document.querySelector("input.i-31").value;
  let i32 = +document.querySelector("input.i-32").value;
...
function f4() {
  let i4 = +document.querySelector("input.i-4").value;
...
function f5() {
  let i5 = +document.querySelector("input.i-5").value;
...
function f7() {
  let i71 = +document.querySelector("input.i-71").value;
  let i72 = +document.querySelector("input.i-72").value;
...
function f8() {
  let s8 = +document.querySelector("select.s-8").value;
...
function f9() {
  let i9 = +document.querySelector("input.i-9").value;
...
function f10() {
  document.querySelector(".out-10").innerHTML = +document.querySelector(
    "select.s-100"
  ).value;
}
...
function f13() {
  let i130 = document.querySelector("input.i-130").value;
  let out13 = document.querySelector(".out-13");
  out13.innerHTML = typeof i130;
  // Как уже отмечалось раньше, значение обьекта input имеет вид данных "строка", даже если тип инпута "number"
  // Чтобы на выводе числового значения тип данных был "number" необходимо добавить "+"
}
...
function f14() {
  let i141 = +document.querySelector("input.i-141").value;
  let i142 = +document.querySelector("input.i-142").value;
  let s143 = document.querySelector("select.s-143").value;
...
function f15() {
  let s151 = +document.querySelector("select.s-151").value;
  let s152 = +document.querySelector("select.s-152").value;
  let s153 = document.querySelector("select.s-153").value;
