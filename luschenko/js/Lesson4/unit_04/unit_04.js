...
function f4() {
  let i4 = document.querySelector("input.i-4");
  document.querySelector(".out-4").innerHTML = i4.checked;
}
...
function f5() {
  let i5 = document.querySelector("input.i-5");
...
function f6() {
  let i6 = document.querySelector("input.i-6");
...
function f7() {
  let i7 = document.querySelector("input.i-7");
  let out72 = document.querySelector(".out-72");
  document.querySelector(".out-71").innerHTML = i7.value;
...
function f8() {
  ...
  //
  document.querySelector("button.b-8").onclick = document.querySelector(
    ".out-8"
  ).innerHTML +=
    "<div class='form-control'> Input 81 <input type='text' class ='i-81'> </div> <button class='button-primary b-81'> Button-81 </button>";
  let b81 = document.querySelector("button.b-81");
  b81.onclick = f81;
}

function f81() {
  let i81 = document.querySelector("input.i-81");
...
function f9() {
  let r9 = document.querySelector("input.r-9");
  let b9 = document.querySelector("button.b-9");
...
function f10() {
  let i10 = document.querySelector("input.i-10");
...
function f11() {
  let i111 = document.querySelector("input.i-111");
  let i112 = document.querySelector("input.i-112");
...
function f12() {
  document.querySelector(".out-12").innerHTML = document.querySelector(
    "input.i-12"
  ).value;
}
...
function f13() {
  document.querySelector(".out-13").innerHTML = document.querySelector(
    "input.i-13"
  ).value;
}
...
function f14() {
  document.querySelector(".out-14").innerHTML = document.querySelector(
    "textarea.t-14"
  ).value;
}
...
function f15() {
  let i15 = document.querySelector("input.i-15");
  document.querySelector("textarea.t-15").value = i15.value;
...
function f16() {
  ...
  document.querySelector(".out-16").innerHTML = document.querySelector(
    "select.s-16"
  ).value;
}
...
function f17() {
  document.querySelector(".out-17").innerHTML = document.querySelector(
    "select.s-17"
  ).value;
}
...
function f18() {
  document.querySelector("input.i-18").value = document.querySelector(
    "select.s-18"
  ).value;
}
...
function f19() {
  let i191 = document.querySelector("input.i-191");
  let i192 = document.querySelector("input.i-192");
...
function f20(e) {
  ...
  let i201 = form.elements["username"];
  let i202 = form.elements["password"];
  document.querySelector(".out-20").innerHTML = i201.value + " " + i202.value;
}
