...
document.querySelector(".three").innerHTML = "<h3> Title3 </h3>";
...
document.querySelector(".four").innerHTML = "<h4> Title4 </h4>";
document.querySelector(".four").innerHTML += "<p> Lorem Ipsum </p>";
...
let a;
a = document.querySelector("p.five");
a.innerHTML = 3.1415;
...
z1 = 6;
z2 = 3;
document.querySelector(".z3").innerHTML = z1 * z2;
...
y1 = 6;
y2 = 3;
document.querySelector(".y3").innerHTML = y1 / y2;
...
x1 = "Hello";
x2 = 5;
document.querySelector(".x3").innerHTML = x1 + x2;
