...
function f2() {
    ...
    document.querySelector('div.out-2').innerHTML = a2[0][1];
    // return
    return a2[0][1];
}
...
function f3() {
    ...
    document.querySelector('div.out-3').innerHTML = a3[2][1][1];
    // return
    return a3[2][1][1];
}
...
function f4() {
    ...
    document.querySelector('div.out-4').innerHTML = a4[1];
    // return
    return a4[1];
}
...
function f11() {
    ...
    document.querySelector('div.out-11').innerHTML = out;
}
...
function f12() {
    ...
    document.querySelector('div.out-12').innerHTML = out;
}
...
function f15() {
    ...
    for (let i = 0 ; i < a15.length ; i++){
        if (a15[i].length > m) m = a15[i].length;
    }
    document.querySelector('div.out-15').innerHTML = m;
}
...
console.log(`a16[3] = 8 : ${a16[3] == 8}`);
console.log(`a16[0][1] = 7 : ${a16[0][1] == 7}`);
console.log(`a16[0][3] = 6 : ${a16[0][3] == 6}`);
...
console.log(`a17[3][2] = 8 : ${a17[3][2] == 8}`);
console.log(`a17[1][1] = 7 : ${a17[1][1] == 7}`);
console.log(`a17[0][2] = 6 : ${a17[0][2] == 6}`);
...
console.log(`a18[0] = 3 : ${a18[0] == 3}`);
console.log(`a18[4][0] = 8 : ${a18[4][0] == 8}`);
console.log(`a18[2][1] = 12 : ${a18[2][1] == 12}`);
...
console.log(`a19[0][0][1] = 3 : ${a19[0][0][1] == 3}`);
console.log(`a19[1][0][2] = 8 : ${a19[1][0][2] == 8}`);
console.log(`a19[2][1][0] = 12 : ${a19[2][1][0] == 12}`);
...
console.log(`a20[1][1][1] = 9 : ${a20[1][1][1] == 9}`);
console.log(`a20[2][2] = 18 : ${a20[2][2] == 18}`);
console.log(`a20[3] = 12 : ${a20[3] == 12}`);
