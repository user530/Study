...
function f14() {
    ...
    document.querySelector('.out-14').innerHTML = output;
}
...
function f16() {
    ...
    document.querySelector('.out-16').innerHTML = output;
}
...
function f17() {
    ...
    document.querySelector('.out-17').innerHTML = output;
}
...
function f18() {
    ...
    let output = '';
    let o18 = document.querySelector('.out-18');
    for(let key in a18){
        if(key == input){
...
function f20() {
    ...
    document.querySelector('.out-20').innerHTML = output;
}
