...
function f1() {
     ...
     * ваш код здесь
     */
    d1.push(document.querySelector('input.i-1').value);
...
function f4() {
    d1.push(document.querySelector('input.i-4').value);
    showArr('.out-4', d1);
}
...
function f5() {
    d1.unshift(document.querySelector('input.i-5').value);
    showArr('.out-5', d1);
}
...
function f6() {
    let a = document.querySelector('input.i-6').value;
    d6[d6.length] = a;
    showArr('.out-6', d6);
    return d6.length;
}
...
function f8() {
    let a = [];
    a.push(document.querySelector('input.i-8').value);
...
function f11() {
    ...
    let b = +document.querySelector('input.i-11').value;
    o11.innerHTML = d11.indexOf(b);
...
function f12() {
    let a = +document.querySelector('input.i-12').value;
...
function f14() {
    let a = +document.querySelector('input.i-14').value;
    d14 = [];
...
function f15() {
    let a = +document.querySelector('input.i-15').value;
    let c = 0;
...
function f18() {
    let a = document.querySelector('input.i-18').value;
    let o18 = document.querySelector('div.out-18');

    o18.innerHTML = d18.includes(a);
}
